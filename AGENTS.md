...
|---|---|
| Repositorio | `Raifeeer/bot-trading`, rama `main`; Cloud Run ejecuta `cbdc186`; herramientas de canary/seguridad versionadas hasta `7e960b1`; handoff actualizado en `2a671f2` |
